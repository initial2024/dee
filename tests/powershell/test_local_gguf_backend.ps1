...
Assert-True ($helperDefault -match 'CONFIRMATION_REQUIRED' -and $helperDefault -match 'BONSAI_AUTO_DOWNLOAD') 'bonsai_helper_requires_confirmation'
Assert-True ($helperConfirmed -match 'CONFIRMED_COMMANDS_ONLY' -and $helperConfirmed -match 'PrismML') 'bonsai_helper_exposes_runtime_warning'

Write-Output "POWERSHELL_TEST_TOTAL=15"
