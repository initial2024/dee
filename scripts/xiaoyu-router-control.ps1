...
Add-ProviderButton '批量管理' { $id=Require-SelectedProvider;if($id){[System.Windows.Forms.MessageBox]::Show('在“选择模型”窗口中可多次设置允许/拒绝/冷却；批量策略命令可通过 xiaoyu-router provider batch-model-policy 执行。','批量模型管理')}}
