...
LM Studio defaults to `http://127.0.0.1:1234/v1`, discovers models through `/v1/models`, and falls back safely when unavailable. API project snippets are redacted and `.env`/private-key files are denied before external transmission.
